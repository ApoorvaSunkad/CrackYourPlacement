...
with a slash '/', transform this path into its simplified canonical path.
...
level, and multiple slashes such as "//" are interpreted as a single slash. 
In this problem, treat sequences of periods not covered by the previous 
